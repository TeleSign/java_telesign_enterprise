...
public class VoiceClientTest extends TestCase {
    ...
    public void testVoiceConstructorDefault() throws Exception {
        VoiceClient client = new VoiceClient(customerId, apiKey);
        assertNotNull(client);
    }

    public void testVoiceConstructorFull() throws Exception {
    ...
    public void testVoice() throws Exception {
        ...
        VoiceClient client = new VoiceClient(this.customerId,
                this.apiKey,
                this.mockServer.url("").toString().replaceAll("/$", ""));

        client.call("18005555555", "Test Message", "ARN", null);
        ...
        assertEquals("path is not as expected", "/v1/voice", request.getPath());
